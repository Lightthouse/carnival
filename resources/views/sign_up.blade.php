    ...
    <form enctype="application/x-www-form-urlencoded" method="post">
        ...
        <div class="btn-group " data-toggle="buttons">
            <label class="btn btn-secondary ">
                <input type="radio" name="raceChoice" id="elf" autocomplete="off"  value="elf" checked> Elf
            </label>
            <label class="btn btn-secondary">
                <input type="radio" name="raceChoice" id="gnome" autocomplete="off" value="gnome" > Gnome
            </label>
        </div>
